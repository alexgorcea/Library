...
namespace Gorcea_Alexandru_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Gorcea_Alexandru_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Gorcea_Alexandru_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {

...
namespace Gorcea_Alexandru_Lab2.Data
{
    public class Gorcea_Alexandru_Lab2Context : DbContext
    {
        ...
        public DbSet<Gorcea_Alexandru_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Gorcea_Alexandru_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
        public DbSet<Gorcea_Alexandru_Lab2.Models.Member> Member { get; set; } = default!;
    }
}
